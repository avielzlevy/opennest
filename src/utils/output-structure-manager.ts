 ...
 * @param fileType - Type of file being generated ('dtos' | 'controllers' | 'decorators' | 'services' | 'common')
 ...
 *
 * @param fileType - Type of file ('dtos' | 'controllers' | 'decorators' | 'services' | 'common')
 ...
 * getFileNameForType('services', 'user') // Returns: 'user.service.ts'
 */
function getFileNameForType(fileType: string, resourceName: string): string {
  switch (fileType) {
    ...
    case 'services':
      return `${resourceName}.service.ts`;
    case 'common':
