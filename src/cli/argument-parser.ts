...
export class ArgumentParser {
  ...
  private setupCommand(): void {
    this.program
      ...
      .option('--graph', 'Generate relationship graph and context files (Phase 9 feature)')
      .addHelpText(
        'after',
        `
Examples:
  ...
  # Generate with relationship graph and context files
  $ opennest ./specs/api.yaml --graph
